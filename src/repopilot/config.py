...
class Settings(BaseSettings):
    ...
    agent_decision_repair_attempts: int = Field(default=1, ge=0, le=2)
    agent_decision_repair_max_chars: int = Field(default=8_000, gt=500, le=50_000)
    agent_finalization_iterations: int = Field(default=2, gt=0, le=10)
