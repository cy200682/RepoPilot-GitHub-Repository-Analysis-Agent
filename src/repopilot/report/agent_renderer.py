...
class AgentMarkdownReportRenderer:
    def render(
        ...
        sections = [
            ...
            f"- Memory calls: {state.memory_call_count}",
            f"- Memory candidates seen: {state.memory_results_seen}",
            f"- Memory entries cited: {state.memory_entries_cited}",
            f"- Memory entries refreshed: {state.memory_entries_refreshed}",
            f"- Memory entries saved: {state.memory_entries_saved}",
            f"- Stale memories rejected: {state.stale_memories_rejected}",
